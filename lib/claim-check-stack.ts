...
export class ClaimCheckStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // Suppress Nag messages for the dead-letter queues & implicitly created resources
    [deadLetterQueue1, deadLetterQueue2].forEach(dlq => {
    ...
    NagSuppressions.addResourceSuppressionsByPath(
      this,
      '/ClaimCheckStack/AWS679f53fac002430cb0da5b7982bd2287/Resource',
      [{ id: 'AwsSolutions-L1', reason: 'Resource is implicitly created.' }]
    );
