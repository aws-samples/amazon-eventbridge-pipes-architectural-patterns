...
export class NormalizerStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    NagSuppressions.addResourceSuppressionsByPath(
      this,
      '/NormalizerStack/AWS679f53fac002430cb0da5b7982bd2287/Resource',
      [{ id: 'AwsSolutions-L1', reason: 'Resource is implicitly created and therefore runtime cannot be controlled.' }]
    );
